...
class TestStatelessVideoManager:
    ...
    def test_sanitize_channel_name_security(self):
        ...
        assert self.manager._sanitize_channel_name('test<>:"|?*channel') == "testchannel"
    ...
    def test_add_to_be_downloaded_success(self):
        ...
        expected_file = self.base_path / "to_be_downloaded" / f"{video_id}_test channel.md"
    ...
    def test_mark_downloaded_from_to_be_downloaded(self):
        ...
        placeholder_file = self.base_path / "to_be_downloaded" / f"{video_id}_test channel.md"
    ...
    def test_extract_video_id_from_filename_patterns(self):
        ...
        assert self.manager._extract_video_id_from_filename("abc123def45_tina huang.md") == "abc123def45"
        
        # Simple pattern: videoId.md
        assert self.manager._extract_video_id_from_filename("abc123def45.md") == "abc123def45"
        
        # Complex pattern with title
        assert self.manager._extract_video_id_from_filename("abc123def45_channel_title.md") == "abc123def45"
