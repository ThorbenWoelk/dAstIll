...
pub fn build_channel_from_records(
    ...
    let earliest_sync_date = if subscription.earliest_sync_date_user_set {
        subscription.earliest_sync_date
    } else {
        subscription.earliest_sync_date.or_else(|| {
            Some(super::default_earliest_sync_date_floor(
