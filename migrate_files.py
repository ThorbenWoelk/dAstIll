#!/usr/bin/env python3
"""
Migration script to move existing transcript files to the new downloaded folder structure
and update the video tracker database with the new paths.
"""
import os
import shutil
...
def main():
    ...
    for file_path in source_dir.glob("*.md"):
        ...
        try:
            ...
            # Update the tracker with the new file path
            tracker.update_status(video_id, 'downloaded', str(dest_file))
            updated_count += 1
