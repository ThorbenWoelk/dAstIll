<script lang="ts">
  ...
  let { open, step, steps, onClose, onStep }: Props = $props();
  ...
  >
    ...
    {#if spotlightRect}
      <div
        ...
        style="top:{spotlightRect.top - PADDING}px;left:{spotlightRect.left - PADDING}px;width:{spotlightRect.width + PADDING * 2}px;height:{spotlightRect.height + PADDING * 2}px"
      ></div>
    {/if}
