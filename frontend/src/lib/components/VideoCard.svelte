...
>
	...
	<div class="flex min-w-0 flex-1 flex-col justify-center gap-1">
		...
		<div class="flex items-center gap-2">
			<p class="text-[11px] font-medium text-[var(--soft-foreground)] opacity-50">
			...
			<div class="text-[9px] font-bold tracking-[0.04em]">
				...
				{:else if video.transcript_status === "failed" || video.summary_status === "failed"}
					<span class="text-rose-500 flex items-center gap-1">
						<svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
					</span>
