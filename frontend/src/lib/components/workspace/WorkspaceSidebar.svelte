<script lang="ts">
  ...
  /** Fixed-position menu must not rely on raising the whole aside (breaks FeatureGuide stacking). */
  ...
  $effect(() => {
    ...
    // Re-run when the button ref binds (first open tick can run before bind:this).
